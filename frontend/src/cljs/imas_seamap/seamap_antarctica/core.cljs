...
(ns imas-seamap.seamap-antarctica.core
  (:require ["react-dom/client" :refer [createRoot]]
            ...
            [imas-seamap.seamap-antarctica.events :as antevents]
            [imas-seamap.fx]
...
(def config-handlers
  {:subs
   ...
   :events
   {:boot                                 [antevents/boot (re-frame/inject-cofx :save-code) (re-frame/inject-cofx :hash-code) (re-frame/inject-cofx :local-storage/get [:seamap-app-state])]
    :construct-urls                       events/construct-urls
    :merge-state                          [events/merge-state]
    :re-boot                              [antevents/re-boot]
    ...
    :map.rich-layer/temporal-query-timestamp-selected [mevents/rich-layer-temporal-query-timestamp-selected]
