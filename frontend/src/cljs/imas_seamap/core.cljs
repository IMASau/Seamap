...
(def config
  {:subs
   {:map/props                            msubs/map-props
    ...
    :map/national-layer-timeline-selected msubs/national-layer-timeline-selected
   ...
   {:boot                                 [events/boot (re-frame/inject-cofx :save-code) (re-frame/inject-cofx :hash-code) (re-frame/inject-cofx :cookie/get [:cookie-state])]
    ...
    :map/national-layer-timeline-selected mevents/national-layer-timeline-selected
