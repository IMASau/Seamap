...
(ns  imas-seamap.futuresofseafood.core
  (:require ["react-dom/client" :refer [createRoot]]
            ...
            [imas-seamap.futuresofseafood.events :as fosevents]
            [imas-seamap.fx]
...
(def config-handlers
  {:subs
   ...
   {:boot                                 [fosevents/boot (re-frame/inject-cofx :save-code) (re-frame/inject-cofx :hash-code) (re-frame/inject-cofx :local-storage/get [:seamap-app-state])]
    ...
    :initialise-layers                    [fosevents/initialise-layers]
