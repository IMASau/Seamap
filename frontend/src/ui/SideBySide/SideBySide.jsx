...
export default function SideBySide({ leftPane, rightPane, onRangeUpdated, rangeValue }) {
  const map = useMap();
  ...
  useEffect(() => {
    ...
    const sideBySideControl = sideBySide(leftPaneEl, rightPaneEl, { onRangeUpdated, rangeValue });
