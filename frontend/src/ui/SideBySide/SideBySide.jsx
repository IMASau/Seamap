...
export default function SideBySide({ leftPane, rightPane, leftLabelText, rightLabelText, onRangeUpdated, rangeValue }) {
  const map = useMap();
  ...
  useEffect(() => {
    ...
    const sideBySideControl = sideBySide(leftPaneEl, rightPaneEl, { onRangeUpdated, rangeValue, leftLabelText, rightLabelText });
