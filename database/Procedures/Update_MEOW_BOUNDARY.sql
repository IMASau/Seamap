-- When an MEOW boundary has been updated, use this stored procedure to update the
-- hardcoded values in the BOUNDARY_MEOW_HABITAT and BOUNDARY_MEOW_BATHYMETRY
